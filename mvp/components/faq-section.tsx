...
const faqs = [
  {
    ...
    answer:
      'MVPの開発費は無料です。私たちは、本開発費が下がったときの成果報酬で成り立っています。下がらなければ報酬はいただきません。提携網を経由せず本開発する場合や中止する場合のみ、MVPの実費として10万円を頂戴します。',
  },
  {
  ...
  },
  {
    ...
    answer:
      'はい。お客様の既存ベンダーを含めて比較いただけます。なお、提携システム会社を経由せずに本開発される場合は、MVPの実費10万円のみ頂戴します。',
  },
  {
